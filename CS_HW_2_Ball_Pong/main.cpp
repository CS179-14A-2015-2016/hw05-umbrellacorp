...
double ball_1_x = window_width / 2;
double ball_1_y = window_height / 2 - 50;
double ball_2_x = window_width / 2;
double ball_2_y = window_height / 2 + 50;
...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        if (ball_1_x <= 50)
        {
            ball_1_x_speed = -1*ball_1_x_speed;
            ball_1_x = window_width / 2;
            ball_1_y = window_height / 2 - 50;
            
            score_right_value++;
        }
        if (ball_1_x >= window_width - 50)
        {
            ball_1_x_speed = -1*ball_1_x_speed;
            ball_1_x = window_width / 2;
            ball_1_y = window_height / 2 - 50;
        ...
        if (ball_1_y <= 50)
        {
            ball_1_y_speed = -1*ball_1_y_speed;
        }
        if (ball_1_y >= window_height - 50)
        {
            ball_1_y_speed = -1*ball_1_y_speed;
        }
        ...
        if (ball_2_x <= 50)
        {
            ball_2_x_speed = -1*ball_2_x_speed;
            ball_2_x = window_width / 2;
            ball_2_y = window_height / 2 + 50;
            
            score_right_value++;
        }
        if (ball_2_x >= window_width - 50)
        {
            ball_2_x_speed = -1*ball_2_x_speed;
            ball_2_x = window_width / 2;
            ball_2_y = window_height / 2 - 50;
        ...
        if (ball_2_y <= 50)
        {
            ball_2_y_speed = -1*ball_2_y_speed;
        }
        if (ball_2_y >= window_height - 50)
        {
            ball_2_y_speed = -1*ball_2_y_speed;
        }
        ...
        if ((abs(ball_1_x - ball_2_x) <= (2*ball_radius)) || (abs(ball_1_y - ball_2_y) <= (2*ball_radius)))
        {
            
            do
            {
                ball_1_x_speed = (ball_1_x_speed + ball_2_x_speed);
                ball_1_y_speed = (ball_1_y_speed + ball_2_y_speed);
                ball_2_x_speed = (ball_1_x_speed + ball_2_x_speed);
                ball_2_y_speed = (ball_1_y_speed + ball_2_y_speed);
            }while ((abs(ball_1_x - ball_2_x) <= (2*ball_radius))||(abs(ball_1_y - ball_2_y) <= (2*ball_radius)));
        }
        
        else
        {
            //Ball 1 collision Paddle Left or Right
            if (((ball_1_x <= 100) && (ball_1_y <= (paddle_left_y - 100))) || ((ball_1_x >= (window_width - 100)) && (ball_1_y <= (paddle_right_y - 100))))
            {
                if ((ball_1_x <= 100) && (ball_1_y <= (paddle_left_y - 100)))
                {
                    ball_1_x_speed = -1*(ball_1_x_speed + paddle_speed);
                }
                else if (((ball_1_x >= (window_width - 100))) && (ball_1_y <= (paddle_right_y - 100)))
                {
                    ball_1_y_speed = -1*(ball_1_y_speed + paddle_speed);
                }
            }
        }
        ...
        //scores
        //score_left_value = ball_1_x_speed;
